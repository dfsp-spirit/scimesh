...
or into an animated GIF with your tool of choice.  For a complete
C++ example that renders 48 full-brain frames, see
`examples/cpp/brain_video/` in the repository.
