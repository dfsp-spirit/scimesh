...
As such, it can replace be used for scientific mesh visualization when rgl/OpenGL is
unavailable (e.g. on macOS without XQuartz, or on HPC clusters, in CI containers, etc.).

All rendering is done in modern C++ and returns in-memory RGBA images
that can be saved to PNG or composited into high-quality figures for publications or presentations.
